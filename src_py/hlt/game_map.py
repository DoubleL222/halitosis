...
class GameMap:
    ...
    def get_cell_ship_queue(self, position):
        return self[position].ship_queue

    #def get_cell_ship_queue(self, i, j):
    #    return self._cells[i][j].ship_queue
    ...
    def set_cell_halite(self, position, new_halite_amount):
        self[position].halite_amount = new_halite_amount
    ...
    def add_ship_to_cell_queue(self, position, ship):
        self[position].ship_queue.append(ship)
    ...
    def add_cell_halite(self, position, halite_to_add):
        self[position].halite_amount += halite_to_add
